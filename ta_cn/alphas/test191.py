...
1)/SMA(ABS(CLOSE-DELAY(CLOSE,1)),12,1)*100,12))"""
    return (SMA(MAX(CLOSE - DELAY(CLOSE, 1), 0), 12, 1) / SMA(ABS(CLOSE - DELAY(CLOSE, 1)), 12, 1) * 100 - TSMIN(
        SMA(MAX(CLOSE - DELAY(CLOSE, 1), 0), 12, 1) / SMA(ABS(CLOSE - DELAY(CLOSE, 1)), 12, 1) * 100, 12)) / (
                   TSMAX(SMA(MAX(CLOSE - DELAY(CLOSE, 1), 0), 12, 1) / SMA(ABS(CLOSE - DELAY(CLOSE, 1)), 12, 1) * 100,
                       12) - TSMIN(
               SMA(MAX(CLOSE - DELAY(CLOSE, 1), 0), 12, 1) / SMA(ABS(CLOSE - DELAY(CLOSE, 1)), 12, 1) * 100, 12))
